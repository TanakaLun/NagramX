          ...
          sed -i 's/Nagram X/YukinoGram/g' TMessagesProj/src/main/java/tw/nekomimi/nekogram/utils/AndroidUtil.java
...
\
        <activity-alias\
            android:enabled="true"\
            android:name="org.telegram.messenger.MonetYukinoIcon"\
            android:targetActivity="org.telegram.ui.LaunchActivity"\
            android:icon="@mipmap/ic_launcher_yukino_monet"\
            android:exported="true">\
\
            <intent-filter>\
                <action android:name="android.intent.action.MAIN" />\
